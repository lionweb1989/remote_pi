...
void main() {
  ...
  group('SoundLevelScale', () {
    test('forPlatform resolves to the scale of the current test host', () {
      // Host-agnostic: the platform factory picks the dBFS scale on
      // darwin hosts and the Android rmsdB scale elsewhere (CI runs
      // on linux). Guards the iOS waveform regression on macOS while
      // staying green on any runner.
